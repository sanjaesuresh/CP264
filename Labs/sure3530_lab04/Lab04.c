...
{  
   for (int numLines=0; numLines < MAX_MSG_NUM; numLines++)
	      for (int msg_len=0; msg_len < MAX_MSG_LNG; msg_len++) msg[numLines][msg_len] = '\0';
   
   
   if (nlines == 0 || p_text == NULL){
